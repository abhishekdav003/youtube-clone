            ...
            <div class="main-section">
                <div class="main-left">
                    ...
                    <button class="yt-side-button">
                        ...
                        <span class="side-channel-label">Amit Bhadana</span>
                    </button>
                    <button class="yt-side-button">
                        <img src={avtar} height={'30px'} width={'30px'}></img>
                        <span class="side-channel-label">TSP</span>
                    </button>
                    <button class="yt-side-button">
                        <img src={tseries} height={'30px'} width={'30px'}></img>
                        <span class="side-channel-label">zee cinema</span>
                    </button>
                    <button class="yt-side-button">
                        <img src={avtar} height={'30px'} width={'30px'}></img>
                        <span class="side-channel-label">Good Morning</span>
                    </button>
                </div>
